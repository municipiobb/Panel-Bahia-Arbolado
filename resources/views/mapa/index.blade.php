...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-10">
                <div id="map_canvas">
                    <img src="{{ url('images/loading.gif') }}" style="width: 25px;height: 25px;">
                </div>
            </div>
    ...
    <script>
        ...
        function loadScript() {
            ...
            script.src = "http://maps.google.com/maps/api/js?key=AIzaSyCvUN-CRtMA8YD1vDpGFpt45VOuJXWIyzo&callback=initialize";
