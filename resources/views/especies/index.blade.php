        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    <div class="panel-heading"><h4>Especies <a href="{{ action('EspeciesController@create') }}"
                                    ...
                                    <td>
                                        @if(!auth()->user()->isAdmin())
                                            <a href="javascript:void(0)"
                                               style="font-size: 18px; color: silver;" title="">
                                            ...
                                            @endif
                                        @else
                                            <a href="{{ action('EspeciesController@edit', $especie->id) }}"
